...
function add_my_custom_scripts(){
    ...
    wp_register_script('nice_scroll', get_stylesheet_directory_uri().'/assets/jquery/jquery.nicescroll.min.js');
...
function add_my_custom_styles(){
    ...
    wp_register_style('fontello_animate', get_stylesheet_directory_uri().'/assets/fontello/animation.css');
    ...
    wp_enqueue_style('fontello_animate');
